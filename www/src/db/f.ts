...
export const fFoodData: Array<FoodData> = [
  {
    ...
    keys: 'falafel, falafel de frito, falafel de grão-de-bico, falafel de fava',
  },
  {
  ...
  },
  {
    ...
    keys: 'farinha de rosca, farinha de pão, farinha de pães, pão ralado, pão seco moído',
  },
  {
  ...
  },
  {
    ...
    keys: 'figo em calda, figos em calda, figo enlatado, figos enlatados',
    oneMeasures: [
      {
        type: 3,
        quantity: 60,
  ...
  },
  {
    ...
    unitOfMeasurement: 0,
    keys: 'galinha, peito de frango, coxa de frango, frango assado, frango desfiado, frango cozido',
    oneMeasures: [
      {
        quantity: 400,
        type: 9,
  ...
  },
  {
    ...
    keys: 'frango assado, frango assado com farofa, frango recheado, frango assado com recheio, frango recheado assado, frango recheado assado com farofa, frango assado com recheio de farofa',
  },
  {
