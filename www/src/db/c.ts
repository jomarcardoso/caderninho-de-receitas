...
export const cFoodData: Array<FoodData> = [
  ...
  },
  {
    ...
    keys: 'café, café passado, café de infusão, café de infusão 10%, café infusão',
    type: 14,
  },
  {
    ...formatMyFood(coffee as unknown as FoodMyFoodData),
  ...
  },
  {
    ...
    type: 11,
    keys: 'cebola palito, cebolas palito, cebolete, cebola para conserva, cebolas para conserva',
  },
  {
    ...
    keys: 'cebolinha, cebolinho, cebolinha-francesa, cebolinha francesa',
    type: 2,
  },
  {
  ...
  },
  {
    ...
    keys: 'chá de erva-doce, erva-doce, erva doce, anis-verde, anis verde, pimpinela-branca, pimpinela branca',
    type: 0,
  },
  {
    name: 'Chapati',
    ...
    keys: 'chapati, pão ázimo, pão azimo, pão sírio, pão indiano, pãozinho indiano, pãozinho sírio',
  },
  {
    ...
    keys: 'chocolate, achocolatado, chocolate em pó, chocolate ao leite',
    type: 5,
  },
  {
  ...
  },
  {
    ...
    keys: 'couve-flor, couve flor, couves-flor, couves-flores, couve-flores',
    oneMeasures: [
      {
        quantity: 600,
        type: 3,
