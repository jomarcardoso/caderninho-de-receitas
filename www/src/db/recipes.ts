...
export const recipes: Array<FoodData> = [
  {
    ...
    recipe: true,
    keys: 'rodelas de abobrinha, abobrinha assada, abobrinha com parmesão',
  },
  {
  ...
  },
  {
    ...
    recipe: true,
    keys: 'cuscuz marroquino, cuscuz com carne, cuscuz marroquino com porco, cuscuz com porco',
  },
  {
  ...
  },
  {
    ...
    recipe: true,
    keys: 'brownie, brownie de castanha, brownie com castanha, brownie cremoso',
  },
  {
    ...
    recipe: true,
    keys: 'filé de frango frango, frango grelhado, frango grelhado com páprica, frango grelhado com páprica e erva-doce',
  },
  {
    name: 'Clotted cream',
    image:
  ...
  },
  {
    ...
    recipe: true,
    keys: 'caipirinha, caipirinha de maracujá, suco de maracujá, caipirinha de maracujá com gengibre, suco de maracujá com gengibre',
  },
  {
  ...
  },
  {
    ...
    recipe: true,
    keys: 'geleia, geleia de figo, geleia de figo e vinho, geleia com vinho',
  },
  {
    ...
    recipe: true,
    keys: 'rabanada, rabanada salgada, rabanada salgada com queijo, rabanada com queijo',
  },
  {
    ...
    recipe: true,
    keys: 'salada de frutas, salada de fruta, salada de fruta com chocolate, salada de frutas com chocolate, salada de frutas com cacau, salada de frutas com nibs de cacau',
  },
  {
  ...
  BEAN_WITH_CUMIN,
  {
    ...
    recipe: true,
    keys: 'carne, carne com batata, carne com batata e cenoura, carne com batata e cenoura na panela de pressão, carne de panela, carne na panela de pressão',
  },
  {
    ...
    recipe: true,
    keys: 'pizza, pizza de mozarela, pizza de muçarela, pizza de mozzarella, pizza muçarela, pizza mozzarella, pizza mozarela, pizza de queijo muçarela, pizza caseira, pizza caseira de mozarela, pizza caseira de muçarela, pizza caseira de mozzarella',
  },
  {
    ...
    recipe: true,
    keys: 'mousse, mousse de chocolate, mousse de chocolate levissima, musse de chocolate, musse',
  },
  {
  ...
  },
  {
    ...
    recipe: true,
    keys: 'gratinado, gratinado de batata, gratinado de batata com frango',
  },
  {
    ...
    recipe: true,
    keys: 'massa caseira, massa caseira com semolina, massa com semolina, massa com sêmola, massa caseira com sêmola',
  },
  {
    ...
    recipe: true,
    keys: 'macarrão, macarrão com legumes, macarrão com legumes assados, massa com legumes, massa com legumes assados',
  },
  {
    ...
    recipe: true,
    keys: 'sopa de feijão, sopa de feijão com macarrão, sopa de feijão e macarrão',
  },
  {
    name: 'Farofa de milho com cenoura e bacon',
    image: 'https://cdn.panelinha.com.br/receita/1639142039327-farofa.jpg',
    recipe: true,
    keys: 'farofa, farofa de milho, farofa de milho com cenoura, farofa de milho com cenoura e bacon, farofa de milho com bacon, farofa com cenoura, farofa com bacon',
  },
  {
  ...
  },
  {
    ...
    recipe: true,
    keys: 'feijão tropeiro mineiro, feijão tropeiro, feijão mineiro, feijão com tropeiro com torresmo, feijão tropeiro com couve',
  },
  {
  ...
  },
  {
    ...
    recipe: true,
    keys: 'quibebe, purê de abóbora, quibebe de abóbora, quibebe de mandioca',
  },
  {
  ...
  },
  {
    ...
    recipe: true,
    keys: 'arroz com figo, arroz com figo seco, arroz com figo seco e especiarias',
  },
  {
    ...
    recipe: true,
    keys: 'salada de feijão, salada de feijão branco, salada de feijão branco com salsão',
  },
  {
  ...
  },
  {
    ...
    recipe: true,
    keys: 'frango na panela, frango na panela de pressão, molho de frango, molho de frango com tomate',
  },
];
