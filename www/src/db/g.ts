...
export const gFoodData: Array<FoodData> = [
  ...
  },
  {
    ...
    keys: 'gergelim, gergelins, semente de gergelim, farinha de gergelim, sésamo, sésamos, semente de sésamo, farinha de sésamo, tahine, taíne, tahin, tahini',
    unitOfMeasurement: 0,
    type: 1,
  },
  {
  ...
  },
  {
    ...
    keys: 'guandu, grãos de guandu, grão-de-guandu, grãos-de-guandu, ingá, inga, ingás, ingas',
    unitOfMeasurement: 0,
    type: 1,
  },
];
