...
export const hFoodData: Array<FoodData> = [
  {
    ...
    keys: 'arroz árabe, hashweh, arroz marroquino, arroz árabe com carne, arroz árabe com carne moída, arroz árabe com especiarias, arroz árabe com carne moída e especiarias',
  },
  {
    name: 'Hortelã',
