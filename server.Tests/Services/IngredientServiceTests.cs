...
namespace server.Tests.Services
{
    ...
    public class IngredientServiceTests
    {
        ...
        // {
        //     string texto = "1 1/2 xícara de açúcar";

        //     var result = _service.SplitTextInMeasureAndRest(texto);

        //     Assert.That(result.MeasureText, Is.EqualTo("1 1/2 xícara"));
        //     Assert.That(result.Rest, Is.EqualTo("de açúcar"));
        // }

        // [Test]
        // public void SplitTextInMeasureAndRest_NoMatch_ReturnsEmptyQuantity()
        // {
        //     string texto = "Açúcar";

        //     var result = _service.SplitTextInMeasureAndRest(texto);

        //     Assert.That(result.MeasureText, Is.EqualTo(""));
        //     Assert.That(result.Rest, Is.EqualTo("Açúcar"));
        // }
        ...
        {
            var result = _service.SplitTextInMeasureAndRest(input);
