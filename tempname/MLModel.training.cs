...
namespace Server
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\anton\Downloads\projetos\caderninho-de-receitas\db\backup\FoodsPt.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"id",inputColumnName:@"id",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"id", sentence1ColumnName: @"name"))      
