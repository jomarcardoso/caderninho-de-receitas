...
namespace Server.Migrations
{
    ...
    [Migration("20251221025109_RecipeVersioning")]
    partial class RecipeVersioning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.RecipeV2", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("MergedIntoRecipeId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RecipesV2", (string)null);
                });
            ...
            modelBuilder.Entity("Server.Models.RecipeRevision", b =>
                {
                    ...
                    b.HasOne("Server.Models.RecipeV2", "Recipe")
                        .WithMany("Revisions")
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Server.Models.RecipeV2", b =>
                {
                    ...
                    b.HasOne("Server.Models.RecipeV2", "MergedIntoRecipe")
                        .WithMany()
