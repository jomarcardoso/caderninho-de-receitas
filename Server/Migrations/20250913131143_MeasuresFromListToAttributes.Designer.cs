...
namespace Server.Migrations
{
    ...
    [Migration("20250913131143_MeasuresFromListToAttributes")]
    partial class MeasuresFromListToAttributes
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("Server.Models.Measure", "Measures", b1 =>
                        {
                            ...
                            b1.Property<double?>("Gram")
                                .HasColumnType("double precision");

                            b1.Property<double?>("Kilo")
                                .HasColumnType("double precision");

                            b1.Property<double?>("Liter")
                                .HasColumnType("double precision");

                            b1.Property<double?>("Literal")
                                .HasColumnType("double precision");

                            b1.Property<double?>("Ml")
                                .HasColumnType("double precision");
