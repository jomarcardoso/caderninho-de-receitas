...
namespace Server.Migrations
{
    ...
    [Migration("20250911110031_MoveSugarToNutritionalInformation")]
    partial class MoveSugarToNutritionalInformation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Server.Models.Food", b =>
                {
                    ...
                    b.OwnsMany("Server.Models.Measure", "Measures", b1 =>
                        {
                            b1.Property<int>("FoodId")
                                .HasColumnType("integer");
                    ...
                    b.OwnsMany("Server.Models.RecipeStep", "Steps", b1 =>
                        {
                            ...
                            b1.OwnsMany("Server.Models.Ingredient", "Ingredients", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("Server.Shared.AminoAcids", "AminoAcids", b3 =>
                                        {
                                    ...
                                    b2.OwnsOne("Server.Shared.Minerals", "Minerals", b3 =>
                                        {
                                            b3.Property<int>("IngredientRecipeStepRecipeId")
                                                .HasColumnType("integer");
                                    ...
                                    b2.OwnsOne("Server.Shared.NutritionalInformation", "NutritionalInformation", b3 =>
                                        {
                                            b3.Property<int>("IngredientRecipeStepRecipeId")
                                                .HasColumnType("integer");
                                    ...
                                    b2.OwnsOne("Server.Shared.Vitamins", "Vitamins", b3 =>
                                        {
                                            b3.Property<int>("IngredientRecipeStepRecipeId")
                                                .HasColumnType("integer");
                            ...
                            b1.OwnsOne("Server.Shared.AminoAcids", "AminoAcids", b2 =>
                                {
                                    b2.Property<int>("RecipeStepRecipeId")
                                        .HasColumnType("integer");
                            ...
                            b1.OwnsOne("Server.Shared.Minerals", "Minerals", b2 =>
                                {
                                    b2.Property<int>("RecipeStepRecipeId")
                                        .HasColumnType("integer");
                            ...
                            b1.OwnsOne("Server.Shared.NutritionalInformation", "NutritionalInformation", b2 =>
                                {
                                    b2.Property<int>("RecipeStepRecipeId")
                                        .HasColumnType("integer");
                            ...
                            b1.OwnsOne("Server.Shared.Vitamins", "Vitamins", b2 =>
                                {
                                    b2.Property<int>("RecipeStepRecipeId")
                                        .HasColumnType("integer");
