...
namespace Server.Migrations
{
    ...
    [Migration("20260126144906_AddFoodAndCategoryRevisions")]
    partial class AddFoodAndCategoryRevisions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.FoodRevision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Server.Models.RecipeCategoryRevision", b =>
                {
                    ...
                    b.HasIndex("RecipeCategoryId", "Status");

                    b.HasIndex("Status", "CreatedAtUtc")
                        .HasDatabaseName("IX_RecipeCategoryRevision_Pending")
                        .HasFilter("\"Status\" = 1");

                    b.ToTable("RecipeCategoryRevision");
                });
            ...
            modelBuilder.Entity("Server.Models.RecipeItem", b =>
                {
                    ...
                    b.ToTable("RecipeListItem", (string)null);
                });
            ...
            modelBuilder.Entity("Server.Models.UserAuthIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Server.Models.FoodRevision", b =>
                {
                    b.HasOne("Server.Models.UserProfile", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Server.Models.UserProfile", "ReviewedByUser")
                        .WithMany()
